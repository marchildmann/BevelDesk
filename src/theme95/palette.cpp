...
const Palette PaletteNight = {
    ...
    IM_COL32(34,48,76,255), IM_COL32(59,90,138,255),   // active title: subtle blue → reads as focused
    IM_COL32(42,42,42,255), IM_COL32(53,53,53,255), IM_COL32(237,237,237,255),
